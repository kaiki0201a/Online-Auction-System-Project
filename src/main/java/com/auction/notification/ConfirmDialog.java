...
public class ConfirmDialog {
    ...
    public static Optional<Boolean> show(Window owner, String title, String body,
        ...
        // Scale-in animation — chạy SAU khi showAndWait() mở dialog
        // FIX: Không gọi show() trước showAndWait() — sẽ gây IllegalStateException
        ...
        // Dùng Platform.runLater để animation chạy sau khi dialog đã được hiển thị bởi showAndWait()
        javafx.application.Platform.runLater(anim::play);
        dialog.showAndWait();
